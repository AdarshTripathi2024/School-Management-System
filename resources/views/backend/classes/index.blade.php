    ...
    <div class="roles-permissions">
        ...
        <div class="mt-8 bg-white rounded border-b-4 border-gray-300">
           ...
           <div class="w-1/12 px-4 py-3">#</div>
            ...
            <div class="w-3/12 px-4 py-3">Class Teacher</div>
            ...
            @foreach ($classes as $class)
                <div class="flex flex-wrap items-center text-gray-700 border-t-2 border-l-4 border-r-4 border-gray-300">
                    ...
                    <div class="w-3/12 px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight">{{ $class->class_name }}</div>
                    <div class="w-3/12 px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight">{{ $class->class_description }}</div>
                    <div class="w-3/12 px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight">{{ $class?->teacher?->user?->name }}</div>
                    <div class="w-2/12 flex items-center justify-end px-3">
                        ...
                        <a href="{{ route('class.view.detail',$class->id) }}" class="ml-1 bg-blue-600 block p-0 border border-blue-600 rounded-sm" title="View Detail">
