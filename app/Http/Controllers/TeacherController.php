...
class TeacherController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('teacher.index')->with('success', 'New Teacher Record created successfully!');;
    }
    ...
    return redirect()->route('teacher.index')->with('success', 'Teacher record deleted successfully!');
    }
